              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full border border-[#E8E4DC] rounded-xl px-3 py-2.5 pr-10 text-sm text-[#1A1918] outline-none focus:border-[#9E8B45]"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(v => !v)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6B6560] hover:text-[#1A1918]"
                    tabIndex={-1}
                  >
                    {showPassword ? (
